...
mixin _$Employee {
  ...
  String get hire_date => throw _privateConstructorUsedError;
...
class _$_Employee implements _Employee {
  ...
  @override
  String toString() {
    return 'Employee(employee_id: $employee_id, first_name: $first_name, last_name: $last_name, photo: $photo, birth_date: $birth_date, hire_date: $hire_date, reports_to: $reports_to, notes: $notes, address: $address, city: $city, country: $country, extension: $extension, home_phone: $home_phone, photo_path: $photo_path, postal_code: $postal_code, region: $region, title: $title, title_of_courtesy: $title_of_courtesy)';
  }
...
abstract class _Employee implements Employee {
  const factory _Employee(
      ...
      required final String hire_date,
